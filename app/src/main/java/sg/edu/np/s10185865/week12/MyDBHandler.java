...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_ACCOUNTS_TABLE = "CREATE TABLE "+ACCOUNT+"("+COLUMN_USERNAME+"TEXT,"+ COLUMN_PASSWORD
                + "TEXT" +")";
    ...
    public UserData findUser(String username){
        String query = "SELECT"+"FROM"+"ACCOUNTS"+"WHERE"+"COLIMN_USERNAME"+"=\""+username+"\"";
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public boolean deleteAccount(String username)
    {
        ...
        if(cursor.moveToFirst()){
            ...
            db.delete(ACCOUNT,COLUMN_USERNAME+ "=?",new String[]{String.valueOf(delData.getMyUserName())});
            cursor.close();
            result = true;
        }
        db.close();
